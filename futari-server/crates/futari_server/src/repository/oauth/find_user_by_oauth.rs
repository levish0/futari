...
use futari_entity::user_oauth_connections::Column as OAuthColumn;
use futari_entity::users::{Entity as UserEntity, Model as UserModel, Relation as UserRelation};
